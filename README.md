...
<h4>TBU(v2) : Docker, Kubernetes, MSA, Redis, Kafka, TypeScript, Responsive Web, Monitoring, Security, Availability&Scalability , Throughput Enhancement(Ex.Batch, DB Sharding), Code Refactoring(Clean Code) , UI Enhancement, Langchain4j  </h4>
